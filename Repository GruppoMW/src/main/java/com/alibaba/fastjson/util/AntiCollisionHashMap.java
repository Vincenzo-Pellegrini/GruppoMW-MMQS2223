...
public class AntiCollisionHashMap<K, V> extends AbstractMap<K, V> implements
    ...
    transient Set<K> keySetT = null;
    transient Collection<V> values2 = null;
    ...
    private int extracted(Object key) {
        return (key instanceof String) ? hash(hashString((String) key))
        : hash(key.hashCode());
    }
    ...
    public Set<K> keySet() {
        ...
        Set<K> ks = keySetT;
        Set<K> nuovoKeySetT = new KeySet();
        return (ks != null ? ks : nuovoKeySetT);
    }
    ...
    public Collection<V> values() {
        Collection<V> vs = values2;
        Collection<V> values3 = new Values();
        return (vs != null ? vs : values3);
    }
    ...
    private Set<Map.Entry<K, V>> entrySet0() {
        ...
        Set<java.util.Map.Entry<K, V>> set = entrySet = new EntrySet();
        return es != null ? es : set;
    }
