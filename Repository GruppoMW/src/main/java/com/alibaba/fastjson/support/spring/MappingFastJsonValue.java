...
public class MappingFastJsonValue implements JSONSerializable {
    ...
    private static final int BROWSER_SECURE_MASK = SerializerFeature.BROWSER_SECURE.mask;
    ...
    public void write(JSONSerializer serializer, Object fieldName, Type fieldType, int features) throws IOException {
        ...
        if ((features & BROWSER_SECURE_MASK) != 0 || (writer.isEnabled(BROWSER_SECURE_MASK))) {
