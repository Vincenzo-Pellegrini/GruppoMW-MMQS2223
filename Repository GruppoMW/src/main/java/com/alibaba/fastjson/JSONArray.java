 ...
 */
public class JSONArray extends JSON implements List<Object>, RandomAccess, Serializable {
    ...
    public <T> List<T> toJavaList(Class<T> clazz) {
        List<T> list1 = new ArrayList<>(this.size());
    ...
    private void readObject(final java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        if (JSONObject.SecureObjectInputStream.fields != null && !JSONObject.SecureObjectInputStream.fieldsError) {
